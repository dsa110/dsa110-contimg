...
def create_flux_monitoring_tables(db_path: str = "/data/dsa110-contimg/state/products.sqlite3"):
...
def create_flux_stability_alert(
    issue: Dict, db_path: str = "/data/dsa110-contimg/state/products.sqlite3"
) -> Optional[int]:
