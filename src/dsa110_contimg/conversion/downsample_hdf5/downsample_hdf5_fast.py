...
Examples:
  ...
  python3 downsample_hdf5_fast.py input.uvh5 output.uvh5 --time-factor 2

  # Frequency downsampling by factor of 4
  python3 downsample_hdf5_fast.py input.uvh5 output.uvh5 --freq-factor 4

  # Combined downsampling with weighted averaging
  python3 downsample_hdf5_fast.py input.uvh5 output.uvh5 --time-factor 2 --freq-factor 4 --method weighted
        """
    )
