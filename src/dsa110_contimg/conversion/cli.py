...
def main(argv: list = None) -> int:
    ...
    test_ms_parser.add_argument(
        "--timebin", type=str, default=None, help="Optional time binning (e.g., '30s')"
    )
    ...
    if args.command == "validate":
        ...
        success = create_minimal_test_ms(args.output, cleanup=args.cleanup)
