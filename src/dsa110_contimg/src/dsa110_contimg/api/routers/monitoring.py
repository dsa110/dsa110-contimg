...
def _get_default_paths() -> tuple[Path, Path]:
    ...
    queue_db = Path(os.getenv("DSA110_QUEUE_DB", "/data/dsa110-contimg/state/streaming_ingest.db"))
    products_db = Path(os.getenv("DSA110_PRODUCTS_DB", "/data/dsa110-contimg/state/products.db"))
