...
def validate_uvh5_file(filepath: Path, *, layout_meta: Optional[Dict] = None) -> Tuple[bool, List[str]]:
    """
...
def validate_subband_group(directory: Path, timestamp: str, *, layout_meta: Optional[Dict] = None) -> Tuple[bool, List[str]]:
    """
