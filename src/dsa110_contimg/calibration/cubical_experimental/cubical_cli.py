...
def main():
    ...
    parser.add_argument(
        "--field",
        help="Manual field selection (e.g., '0' or '0~1')"
    )
    parser.add_argument(
        "--refant",
        default="103",
    ...
    parser.add_argument(
        "--output-dir",
        required=True,
        help="Output directory for calibration tables"
    )
    parser.add_argument(
        "--convert-to-casa",
        action="store_true",
    ...
    if not CUBICAL_AVAILABLE:
        ...
        print("Install with: pip install 'cubical[lsm-support]@git+https://github.com/ratt-ru/CubiCal.git@1.4.0'")
        return 1
