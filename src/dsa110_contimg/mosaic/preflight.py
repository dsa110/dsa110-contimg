...
def validate_preflight_conditions(
    ...
    if output_path_obj.exists() or (output_path_obj.parent / f"{output_path_obj.name}.fits").exists():
...
def estimate_resources(
    ...
    try:
        ...
        if total_size_mb > 0:
            ...
            estimates['estimated_disk_gb'] = max(estimates['estimated_disk_gb'], 0.1)  # Minimum 100MB
    except Exception:
