...
class LegacyWorkflowAdapter:
    ...
    def run_workflow_job(self, job_id: int, params: Dict[str, Any]) -> None:
        ...
        try:
            ...
            calibration_params = {}
            calibration_keys = [
                "field", "refant", "solve_delay", "solve_bandpass", "solve_gains",
                "model_source", "gain_solint", "gain_calmode", "bp_combine_field",
                "prebp_phase", "flag_autocorr", "do_flagging", "use_existing_tables",
                "existing_k_table", "existing_bp_table", "existing_g_table",
                "k_combine_spw", "k_t_slow", "k_t_fast", "k_uvrange", "k_minsnr",
                "k_skip_slow", "gain_t_short", "gain_uvrange", "gain_minsnr", "fast"
            ]
