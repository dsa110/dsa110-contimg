...
#OVRO_LON = ovro_loc.lat.value
#OVRO_LAT = ovro_loc.lat.value
#OVRO_ALT = ovro_loc.height.value
...
# Backup IERS table
IERS_TABLE = "/data/jfaber/hdf5_to_ms/calib_data/finals2000A.all" #f"file://{dsacalib.__path__[0]}/data/finals2000A.all"
# Templates & other package data
PKG_DATA_PATH = "/data/jfaber/hdf5_to_ms/calib_data/" #f"{dsacalib.__path__[0]}/data/"
