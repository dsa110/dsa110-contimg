#!/usr/bin/env python3
"""
Test script to test UVW recalculation method directly
"""
...
async def test_uvw_recalculation_method():
    print('🔍 Testing UVW Recalculation Method (Direct Implementation)')
    print('=' * 60)
    ...
    # Test UVW recalculation step by step (same as working test)
    ...
    try:
        ...
        print('\\nTesting MS file writing with corrected UVW...')
        corrected_ms_file = 'data/ms/2025-09-05T03:23:15_corrected.ms'
...
if __name__ == '__main__':
    asyncio.run(test_uvw_recalculation_method())
