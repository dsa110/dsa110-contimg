...
def test_solve_calibration_for_group_success(
    mosaic_manager, registered_group, mock_ms_files, tmp_path
):
...
@pytest.mark.integration
def test_apply_calibration_to_group_success(
    mosaic_manager, registered_group, mock_ms_files, tmp_path
):
...
def test_full_workflow_integration(
    mosaic_manager, registered_group, mock_ms_files, tmp_path, temp_dirs
):
