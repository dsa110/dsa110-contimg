...
def benchmark_workflow_processing(
    orchestrator: MosaicOrchestrator, iterations: int = 10
) -> dict:
...
def main():
    ...
    with tempfile.TemporaryDirectory() as tmpdir:
        ...
        print(f"Workflow Processing: {workflow_stats['mean']:.6f}s ± {workflow_stats['stdev']:.6f}s")
