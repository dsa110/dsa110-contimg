...
@pytest.mark.skipif(not UVH5_DIR.exists(), reason="Synthetic UVH5 samples not available")
def test_all_sample_uvh5_files_are_valid():
    layout_path = REPO_ROOT / "src" / "dsa110_contimg" / "simulation" / "config" / "reference_layout.json"
