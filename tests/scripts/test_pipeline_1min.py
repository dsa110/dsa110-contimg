...
if __name__ == "__main__":
    ...
    if len(sys.argv) < 2:
        print(
            "Usage: python test_pipeline_1min.py <ms_path> [output_dir] [--skip-cal]",
            flush=True,
        )
        print("\nExample:", flush=True)
        print(
            "  python test_pipeline_1min.py /data/dsa110-contimg/ms/2025-11-02T13:40:03_1min.ms /tmp/pipeline_test",
            flush=True,
        )
        sys.exit(1)
