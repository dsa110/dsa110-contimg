...
This directory contains comprehensive examples of unit testing with mocking for the DSA-110 pipeline.

## Overview

These tests demonstrate how to test pipeline logic **without running actual CASA/WSClean operations**, making tests fast and reliable.
...
1. **Isolate Dependencies**: Mock all external dependencies (CASA, WSClean, file I/O)
2. **Test Logic, Not Implementation**: Focus on business logic, not internal details
