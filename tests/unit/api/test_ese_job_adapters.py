...
from dsa110_contimg.api.job_adapters import run_ese_detect_job, run_batch_ese_detect_job
...
class TestRunBatchESEDetectJob:
    ...
    def test_run_batch_ese_detect_job_all_sources(self, mock_detect, temp_products_db):
        ...
        cursor.execute(
            ...
            VALUES (?, ?, ?, ?, ?)
            """,
            ("batch_ese-detect", time.time(),
             "pending", 1, '{"min_sigma": 5.0}'),
        )
