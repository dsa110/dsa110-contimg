...
@pytest.mark.unit
def test_provenance_tracking_with_validate_solve_success(temp_registry_db, mock_caltable_path):
...
@pytest.mark.unit
def test_provenance_quality_metrics_extraction_smoke(temp_registry_db, mock_caltable_path):
