        ...
        if len(field_rows) > 0:
            ...
            if len(non_zero) > 0:
                ...
                if phase_std_deg < 0.01 and max_imag < 1e-6:
                    print(f'  ✓ MODEL_DATA is purely real (phase ≈ 0) - consistent with source at phase center')
                else:
                    print(f'  ✗ MODEL_DATA has phase variation - may indicate source not at phase center')
