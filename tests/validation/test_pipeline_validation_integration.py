...
class TestValidationLogic:
        ...
        def mock_table_context_manager(path, readonly=True):
            ...
            if "SPECTRAL_WINDOW" in path:
                ...
                mock_table.__enter__.return_value.colnames.return_value = [
                    'DATA', 'ANTENNA1', 'ANTENNA2', 'TIME'
                ]
                
            mock_table.__exit__ = MagicMock(return_value=None)
            return mock_table
            
        with patch('dsa110_contimg.conversion.helpers.table', side_effect=mock_table_context_manager):
        ...
        def mock_table_context_manager(path, readonly=True):
            ...
            if "ANTENNA" in path:
                ...
                mock_positions = np.array([
                    ...
                    [-2409150.50, -4478573.22, 3838617.84],  # 5cm error - acceptable
    ...
    def test_model_data_quality_validation_logic(self):
        ...
        def mock_table_context_manager(path, readonly=True):
            ...
            mock_table.__enter__.return_value.colnames.return_value = ['MODEL_DATA', 'FIELD_ID']
    ...
    def test_reference_antenna_stability_logic(self):
        ...
        with patch('dsa110_contimg.conversion.helpers.table', side_effect=mock_table_context_manager):
            with patch('dsa110_contimg.conversion.helpers.os.path.join', return_value="/fake/ms/path/ANTENNA"):
...
class TestValidationWorkflow:
    ...
    def test_validation_workflow_catches_all_issues(self):
        ...
        for func in validation_functions:
            assert func.__doc__ is not None, f"Validation function {func.__name__} lacks documentation"
            assert "Args:" in func.__doc__ or "Parameters:" in func.__doc__, \
