...
A generalized script that automatically analyzes any directory structure and generates a Mermaid flowchart diagram showing the organization and relationships between modules.
...
```bash
python generate_structure_diagram.py /data/dsa110-contimg/docs docs_structure.svg
python generate_structure_diagram.py /data/dsa110-contimg/scripts scripts_structure.svg
```
...
You can edit the generated `.mmd` file and re-render it, or modify the script to:
