...
def create_app(config: ApiConfig | None = None) -> FastAPI:
    ...
    # Generated to fix degraded service health status
    # These endpoints were identified as missing (404) by service diagnostics
    ...
    def get_health_services():
        ...
        # Check databases
        from dsa110_contimg.api.health import _check_calibration_registry, _check_products_database
    ...
    def list_sources(limit: int = Query(10, ge=1, le=100)):
        ...
        if not master_sources_db.exists():
            return {
                ...
                "total": 0,
                "limit": limit,
                "note": "master_sources.sqlite3 not found",
            }
