...
Usage:
    ...
    python -m dsa110_contimg.catalog.build_full_catalogs_cli --all

    # Build specific catalog
    python -m dsa110_contimg.catalog.build_full_catalogs_cli nvss
    python -m dsa110_contimg.catalog.build_full_catalogs_cli first
    python -m dsa110_contimg.catalog.build_full_catalogs_cli atnf

    # Check status of all catalogs
    python -m dsa110_contimg.catalog.build_full_catalogs_cli --status

    # Force rebuild
    python -m dsa110_contimg.catalog.build_full_catalogs_cli nvss --force
"""
...
""",
    ...
    print("  python -m dsa110_contimg.catalog.build_full_catalogs_cli <catalog>")
    print("  python -m dsa110_contimg.catalog.build_full_catalogs_cli --all")
    return 0
