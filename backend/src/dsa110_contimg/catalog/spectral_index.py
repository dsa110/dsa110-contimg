...
def create_spectral_indices_table(db_path: str = "/data/dsa110-contimg/state/products.sqlite3"):
...
def get_spectral_index_for_source(
    source_id: str, db_path: str = "/data/dsa110-contimg/state/products.sqlite3"
) -> Optional[Dict]:
