"""
Mosaic Orchestrator - Bridge between ABSURD adapter and mosaic pipeline.

This module provides the MosaicOrchestrator class that the ABSURD adapter
    ...
    def create_mosaic_for_group(
        ...
        Returns:
            Dict with:
                ...
                - metadata: Mosaic statistics
                - photometry: Photometry results (if enabled)
