...
class FigureConfig:
    ...
    Attributes:
        ...
        cmap: Default colormap for images
        font_size: Base font size
        title_size: Title font size (None = auto from font_size)
        label_size: Axis label font size (None = auto)
        tick_size: Tick label font size (None = auto)
        colorbar: Show colorbar by default
        grid: Show grid by default
