...
CLI:
    ...
    python -m dsa110_contimg.validation.ms_validator /path/to/file.ms --calibrator 3C286
"""
...
class MSValidator:
    ...
    def validate_all(
        ...
        Args:
            calibrator_name: Name of calibrator to check against
            calibrator_ra_deg: Calibrator RA in degrees
            calibrator_dec_deg: Calibrator Dec in degrees
            check_data: Whether to check DATA column (slower)
...
def validate_ms(
    ...
    Args:
        ...
        calibrator_ra_deg: Calibrator RA in degrees
        calibrator_dec_deg: Calibrator Dec in degrees
        check_data: Whether to check DATA column
