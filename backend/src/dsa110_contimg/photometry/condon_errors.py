...
class CondonFluxErrors:
    ...
    Attributes:
        ...
        major_err_arcsec: Major axis error (arcsec)
        minor_err_arcsec: Minor axis error (arcsec)
        pa_err_deg: Position angle error (degrees)
    """
...
class CondonPositionErrors:
    ...
    Attributes:
        ...
        error_radius_arcsec: Combined error radius (arcsec)
    """
...
class CondonErrors:
    ...
    Attributes:
        ...
        systematic_ra_arcsec: Systematic RA error added (arcsec)
        systematic_dec_arcsec: Systematic Dec error added (arcsec)
    """
...
def calc_condon_position_errors(
    ...
    *,
    ...
    Args:
        ...
        beam_major_arcsec: Beam major axis (arcsec)
        beam_minor_arcsec: Beam minor axis (arcsec)
        alpha_maj2: Exponent for major axis scaling (default 2.5)
