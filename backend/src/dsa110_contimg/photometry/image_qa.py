...
class ImageRMSMetrics:
    ...
    Attributes:
        ...
        rms_max: Maximum RMS value (Jy/beam)
        rms_mean: Mean RMS value (Jy/beam)
        rms_std: Standard deviation of RMS values (Jy/beam)
        n_valid_pixels: Number of valid (non-NaN) pixels in noise map
        coverage_fraction: Fraction of image with valid RMS values
    """
...
class ImageQAMetrics:
    ...
    Attributes:
        ...
        dynamic_range: Peak flux / median RMS
        peak_flux: Maximum flux in image (Jy/beam)
        theoretical_rms: Expected thermal noise (if calculable)
        beam_major_arcsec: Beam major axis
        beam_minor_arcsec: Beam minor axis
        beam_pa_deg: Beam position angle
        freq_hz: Central frequency
        n_channels: Number of frequency channels
        warnings: List of QA warnings
    """

    image_path: str
    rms: Optional[ImageRMSMetrics] = None
    dynamic_range: Optional[float] = None
    peak_flux: Optional[float] = None
    theoretical_rms: Optional[float] = None
