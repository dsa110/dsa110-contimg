...
class SourceMorphologyMetrics:
    ...
    Attributes:
        ...
        is_resolved: Whether source is significantly resolved
        a_over_b: Ratio of major to minor axis (ellipticity)
        chi_squared_fit: Chi-squared of Gaussian fit to source
        reduced_chi_squared: Reduced chi-squared (chi2 / dof)
    """

    compactness: float
    is_resolved: bool = False
    a_over_b: Optional[float] = None
    chi_squared_fit: Optional[float] = None
...
class IslandMetrics:
    ...
    Attributes:
        ...
        has_siblings: Whether source has other components in same island
        n_siblings: Number of sibling components
        island_id: Island identifier (if available)
        total_island_flux: Total integrated flux of island
    """
    ...
    total_island_flux: Optional[float] = None
...
class SpatialMetrics:
    ...
    Attributes:
        ...
        n_neighbours_1arcmin: Number of neighbors within 1 arcmin
        is_isolated: Whether source is isolated (no neighbors within threshold)
        crowding_parameter: Local source density metric
    """
    ...
    crowding_parameter: Optional[float] = None
...
class SourceQAMetrics:
    ...
    Attributes:
        ...
        local_rms: Local RMS at source position (Jy/beam)
        snr: Signal-to-noise ratio (flux_peak / local_rms)
        morphology: Morphological metrics
        island: Island/component metrics
        spatial: Spatial relationship metrics
    """
    ...
    local_rms: float
    snr: float
    morphology: Optional[SourceMorphologyMetrics] = None
    island: Optional[IslandMetrics] = None
...
def compute_morphology_metrics(
    flux_peak: float,
    flux_int: float,
    major_arcsec: Optional[float] = None,
    minor_arcsec: Optional[float] = None,
    ...
    Args:
        ...
        minor_arcsec: Fitted minor axis (arcsec)
...
def compute_source_qa_metrics(
    ...
    *,
    ...
    chi_squared: Optional[float] = None,
    dof: Optional[int] = None,
    island_components: Optional[List[Dict[str, float]]] = None,
    island_id: Optional[str] = None,
    ...
    Args:
        ...
        flux_int: Integrated flux (Jy)
        local_rms: Local RMS noise (Jy/beam)
        major_arcsec: Fitted major axis
        minor_arcsec: Fitted minor axis
        beam_major_arcsec: Beam major axis
        beam_minor_arcsec: Beam minor axis
        chi_squared: Chi-squared of fit
        dof: Degrees of freedom
