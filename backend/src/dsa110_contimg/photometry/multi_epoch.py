...
class WeightedPositionStats:
    ...
    Attributes:
        ...
        wavg_uncertainty_ew: Weighted uncertainty in RA/EW direction (degrees)
        wavg_uncertainty_ns: Weighted uncertainty in Dec/NS direction (degrees)
...
class FluxAggregateStats:
    ...
    Attributes:
        ...
        min_flux_int: Minimum integrated flux
        max_flux_int: Maximum integrated flux
        min_flux_peak: Minimum peak flux
        max_flux_peak: Maximum peak flux
        std_flux_int: Standard deviation of integrated flux
        std_flux_peak: Standard deviation of peak flux
        n_detections: Number of detections
        n_forced: Number of forced photometry measurements
    """
...
class NewSourceMetrics:
    ...
    Attributes:
        ...
        is_new: Whether this is a genuinely new source
        first_detection_mjd: MJD of first detection
        first_detection_snr: SNR of first detection
        n_images_missed: Number of images where source was below threshold
    """

    new_high_sigma: float
    is_new: bool
    first_detection_mjd: Optional[float] = None
    first_detection_snr: Optional[float] = None
...
class MultiEpochSourceStats:
    ...
    Attributes:
        ...
        flux: Flux aggregate statistics
        snr: SNR aggregate statistics
        new_source: New source validation metrics
        n_measurements: Total number of measurements
        n_selavy: Number from source finder (Selavy/Aegean)
        n_forced: Number from forced photometry
        n_relations: Number of related sources
        n_siblings: Number of siblings (multi-component)
    """
    ...
    new_source: Optional[NewSourceMetrics] = None
...
def calc_new_source_significance(
    ...
    previous_mjd_values: Optional[np.ndarray] = None,
