...
from dsa110_contimg.catalog.coverage import CATALOG_COVERAGE
...
class SyntheticSource:
    ...
    major_axis_arcsec: Optional[float] = None
    minor_axis_arcsec: Optional[float] = None
...
class SourceSelector:
    ...
    def _lookup_reference_frequency(self) -> Optional[float]:
    ...
    @staticmethod
    def _safe_get(row: pd.Series, column: str) -> Optional[float]:
