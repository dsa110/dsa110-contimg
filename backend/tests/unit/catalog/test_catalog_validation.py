...
class TestGetImageFrequency:
    ...
    def test_restfrq_keyword(self, tmp_path):
        ...
        # get_image_frequency expects GHz and multiplies by 1e6, so 1400 GHz -> 1.4e9 Hz
        # Actually the function multiplies by 1e6, not 1e9, so we need 1400 to get 1.4e9
        hdu.header["RESTFRQ"] = 1400  # In units that * 1e6 = 1.4e9 Hz
