...
- [ ] Review test_batch_thumbnails.py for conversion to contract tests
- [ ] Review test_services_monitor.py for conversion to integration tests
- [ ] Extract pure functions from test_batch_qa.py for direct testing
- [ ] Verify test_job_queue.py coverage is not redundant with contract tests
- [ ] No immediate action needed for API tests (mocking is appropriate)
