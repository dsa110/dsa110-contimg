...
with table(ms_path + "/FIELD", readonly=True) as field:
    ...
    if max_offset < 0.1:
        ...
        print("ft() uses PHASE_DIR from the FIELD table, but may have phase center bugs.")
        print("If fields have different phase centers, MODEL_DATA may be calculated")
        print("at different positions for different fields.")
