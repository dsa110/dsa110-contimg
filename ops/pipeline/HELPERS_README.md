...
**Date:** 2025-11-05  
**Purpose:** Consolidate duplicate helper functions from multiple pipeline scripts
...
- `write_ms_group_via_uvh5_to_ms()` - Convert subband UVH5 files to MS via concat
