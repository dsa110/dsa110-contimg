...
export default function ImageBrowser({ onSelectImage, selectedImageId }: ImageBrowserProps) {
  ...
  const getInitialFilters = (): ImageFilters => {
    ...
    if (searchParams.get("image_type"))
      filters.image_type = searchParams.get("image_type") || undefined;
    ...
    if (searchParams.get("dec_min"))
      filters.dec_min = parseFloat(searchParams.get("dec_min") || "");
    if (searchParams.get("dec_max"))
      filters.dec_max = parseFloat(searchParams.get("dec_max") || "");
    if (searchParams.get("noise_max"))
      filters.noise_max = parseFloat(searchParams.get("noise_max") || "");
    if (searchParams.get("has_calibrator"))
      filters.has_calibrator = searchParams.get("has_calibrator") === "true";
  ...
  useEffect(() => {
    ...
    if (filters.has_calibrator !== undefined)
      params.set("has_calibrator", filters.has_calibrator.toString());
  ...
  return (
    <LocalizationProvider dateAdapter={AdapterDayjs}>
      <Paper sx={{ p: 2, height: "100%", display: "flex", flexDirection: "column" }}>
        ...
        >
          <Typography variant="h6">Image Browser</Typography>
          <IconButton
            size="small"
