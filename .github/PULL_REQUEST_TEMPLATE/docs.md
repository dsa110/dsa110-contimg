...
Thank you for improving the docs. Please fill out the checklist to help reviewers.
...
- Confirm placement matches the decision tree in `docs/DOCUMENTATION_QUICK_REFERENCE.md`: [ ]
...
- Considered special characters; sanitized per `docs/javascripts/mermaid-init.js`: [ ]
- Images/attachments placed under `docs/images/` or page‑local folder and referenced with relative paths: [ ]
