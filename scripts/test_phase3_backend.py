...
from dsa110_contimg.pipeline.event_bus import get_event_bus, EventType, PipelineEvent
...
def test_event_bus():
    ...
    from dsa110_contimg.pipeline.event_bus import PhotometryMeasurementCompleted, EventType
    import time
