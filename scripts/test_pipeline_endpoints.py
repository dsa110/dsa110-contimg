...
from dsa110_contimg.pipeline.state import SQLiteStateRepository, JobState
from dsa110_contimg.database.jobs import ensure_jobs_table

def create_test_execution(repo: SQLiteStateRepository, job_type: str = "workflow", status: str = "running"):
