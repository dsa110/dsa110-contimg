...
def load_ra_dec_from_db(name: str, vla_db: Optional[str]) -> Optional[Tuple[float, float]]:
    """
...
def load_flux_jy_from_db(name: str, vla_db: Optional[str], band: str = '20cm') -> Optional[float]:
    """
