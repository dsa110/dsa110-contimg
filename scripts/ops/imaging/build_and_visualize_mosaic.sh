#!/bin/bash
# Build mosaic and create visualizations
# Run this script in the foreground to see progress
...
if [ $? -ne 0 ]; then
    echo "Mosaic build failed. Exiting."
    exit 1
fi
...
$PYTHON scripts/create_mosaic_visualizations.py
