...
if [[ "$DRY_RUN" == "false" ]]; then
    mkdir -p "$PROJECT_ROOT/internal/docs/dev-notes/analysis"
    mkdir -p "$PROJECT_ROOT/internal/docs/dev-notes/status/2025-01"
    mkdir -p "$PROJECT_ROOT/internal/docs/dev-notes/notes"
...
move_file "$PROJECT_ROOT/DASHBOARD_ENDPOINT_TEST_RESULTS.md" \
          "$PROJECT_ROOT/internal/docs/dev-notes/status/2025-01/dashboard_endpoint_test_results.md"

move_file "$PROJECT_ROOT/DASHBOARD_REAL_DATA_IMPLEMENTATION.md" \
          "$PROJECT_ROOT/internal/docs/dev-notes/status/2025-01/dashboard_real_data_implementation.md"

move_file "$PROJECT_ROOT/DASHBOARD_TBD_STATUS.md" \
          "$PROJECT_ROOT/internal/docs/dev-notes/status/2025-01/dashboard_tbd_status.md"

move_file "$PROJECT_ROOT/ENDPOINT_TEST_SUMMARY.md" \
          "$PROJECT_ROOT/internal/docs/dev-notes/status/2025-01/endpoint_test_summary.md"

move_file "$PROJECT_ROOT/ENDPOINT_VERIFICATION_COMPLETE.md" \
          "$PROJECT_ROOT/internal/docs/dev-notes/status/2025-01/endpoint_verification_complete.md"

move_file "$PROJECT_ROOT/SKYVIEW_IMAGE_DISPLAY_VERIFICATION.md" \
          "$PROJECT_ROOT/internal/docs/dev-notes/status/2025-01/skyview_image_display_verification.md"

move_file "$PROJECT_ROOT/SKYVIEW_SPRINT1_COMPLETE.md" \
          "$PROJECT_ROOT/internal/docs/dev-notes/status/2025-01/skyview_sprint1_complete.md"

move_file "$PROJECT_ROOT/SKYVIEW_TEST_RESULTS.md" \
          "$PROJECT_ROOT/internal/docs/dev-notes/status/2025-01/skyview_test_results.md"

move_file "$PROJECT_ROOT/SKYVIEW_TROUBLESHOOTING.md" \
          "$PROJECT_ROOT/internal/docs/dev-notes/status/2025-01/skyview_troubleshooting.md"

move_file "$PROJECT_ROOT/TESTING_SUMMARY.md" \
          "$PROJECT_ROOT/internal/docs/dev-notes/status/2025-01/testing_summary.md"

move_file "$PROJECT_ROOT/TEST_RESULTS.md" \
          "$PROJECT_ROOT/internal/docs/dev-notes/status/2025-01/test_results.md"

move_file "$PROJECT_ROOT/VALIDATION_DEMONSTRATION.md" \
          "$PROJECT_ROOT/internal/docs/dev-notes/status/2025-01/validation_demonstration.md"
...
move_file "$PROJECT_ROOT/TIME_INVESTIGATION_REPORT.md" \
          "$PROJECT_ROOT/internal/docs/dev-notes/analysis/time_investigation_report.md"

move_file "$PROJECT_ROOT/TIME_VALIDATION_STRATEGY.md" \
          "$PROJECT_ROOT/internal/docs/dev-notes/analysis/time_validation_strategy.md"

move_file "$PROJECT_ROOT/DUPLICATE_TIME_INVESTIGATION.md" \
          "$PROJECT_ROOT/internal/docs/dev-notes/analysis/duplicate_time_investigation.md"

move_file "$PROJECT_ROOT/BUG_REPORT.md" \
          "$PROJECT_ROOT/internal/docs/dev-notes/analysis/bug_report.md"
...
move_file "$PROJECT_ROOT/ARCHITECTURAL_ELEGANCE_BRAINSTORM.md" \
          "$PROJECT_ROOT/internal/docs/dev-notes/notes/architectural_elegance_brainstorm.md"

move_file "$PROJECT_ROOT/ARCHITECTURE_OPTIMIZATION_RECOMMENDATIONS.md" \
          "$PROJECT_ROOT/internal/docs/dev-notes/notes/architecture_optimization_recommendations.md"

move_file "$PROJECT_ROOT/PYUVDATA_USAGE_ANALYSIS.md" \
          "$PROJECT_ROOT/internal/docs/dev-notes/notes/pyuvdata_usage_analysis.md"
...
move_file "$PROJECT_ROOT/src/dsa110_contimg/RA_CALCULATION_ISSUE.md" \
          "$PROJECT_ROOT/internal/docs/dev-notes/analysis/ra_calculation_issue.md"

move_file "$PROJECT_ROOT/src/dsa110_contimg/TIME_HANDLING_ISSUES.md" \
          "$PROJECT_ROOT/internal/docs/dev-notes/analysis/time_handling_issues.md"
