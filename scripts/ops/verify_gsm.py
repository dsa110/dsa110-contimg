...
print(f"   :check: Log10 transformation successful")
...
print(f"   :check: HEALPix properties:")
print(f"     NSIDE: {nside}")
print(f"     NPIX: {npix}")
...
try:
    ...
    print("   :check: hp.mollview() works correctly")
    print("     (Plot generated but not displayed in headless mode)")
except Exception as e:
    print(f"   :cross: hp.mollview() failed: {e}")
    sys.exit(1)
...
print("  - pygdsm.GlobalSkyModel16().generate(1400) :check:")
print("  - np.log10(sky_map) :check:")
print("  - hp.mollview() :check:")
