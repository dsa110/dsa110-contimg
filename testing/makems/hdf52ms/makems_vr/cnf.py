...
import dsa_syslog as dsl
from pkg_resources import Requirement, resource_filename

ETCDCONF = "/data/jfaber/hdf5_to_ms/conf_utils/etcdConfig.yml" #resource_filename(Requirement.parse("dsa110-pyutils"), "dsautils/conf/etcdConfig.yml")
CNFCONF = "/data/jfaber/hdf5_to_ms/conf_utils/cnfConfig.yml" #resource_filename(Requirement.parse("dsa110-pyutils"), "dsautils/conf/cnfConfig.yml")
...
CAL_DATA = {
    'caltime_minutes': 5,
    'refant': ['103'],
    'msdir': '/home/ubuntu/caldata/calibration/',
    'beamformer_dir': '/home/ubuntu/caldata/beamformer_weights/',
    'hdf5_dir': '/home/ubuntu/caldata/correlator/',
    'caltable': '/home/ubuntu/proj/dsa110-shell/dsa110-calib/dsacalib/data/calibrator_sources.csv',
    ...
    'bfarchivedir': '/home/ubuntu/caldata/T3/calibs/',
    'antennas_in_ms': [
        '24',
        '25',
        '26',
    ...
    'el_offset_dsc': 'Reported pointing -- True pointing. A negative means the antenna was pointing too low. '+\
            'e.g. a -2 at a dec of 40 means the antenna was pointed at 38 instead.  We need to point the antenna to 42 to get it to point at 40. '+\
            'New pointing command = Desired pointing - pointing offset'
}
