...
#mstransform(vis=os.path.join(basepath, msfile),
#            outputvis=os.path.join(basepath, msfilesb),
...
#phaseshift(vis=f'/data/jfaber/nsfrb_cand/calmsdir/phasecal/{msfile}',
#       outputvis=f'/data/jfaber/nsfrb_cand/calmsdir/phasecal/{msfilefix}',
...
# --------------------------------
#applycal(vis=f'/data/jfaber/nsfrb_cand/calmsdir/phasecal/{msfileavg}',
#         field='', # apply to all fields
#         gaintable=[
#            '/data/jfaber/nsfrb_cand/calmsdir/phasecal/nvss_top10_063p212_69p005.gcal.p'    # if performing bandpass
#         ],
#         interp=[
#            'nearest'    # phase
#         ],
