...
test.describe('Dashboard Combined Tests @regression', () => {
  ...
  test('Sky Viewer component renders', async ({ page }) => {
    ...
    const noImageMessage = page.locator('text=No image selected').or(page.locator('text=Select an image'));
  ...
  test('JS9 display fills container width', async ({ page }) => {
    ...
    const js9Container = page.locator('#skyViewDisplay, [id*="skyView"], .JS9DisplayContainer').first();
