...
This section documents recommended patterns for loading async data in
components.
...
export function SourceDetailPage() {
  ...
  const { data: crossmatches, isLoading: crossmatchLoading } =
    useCrossmatches(id);
...
**Why:** TanStack Query handles caching, deduplication, retries, and error
