...
This directory contains vendored (locally packaged) dependencies that cannot be
installed via npm for various reasons.
...
- The published npm package for Aladin Lite v3 is in beta and not yet stable on
  npm registry
...
Only vendor packages when absolutely necessary. Prefer npm packages whenever
possible.
...
2. Update package.json to reference it:
   `"package-name": "file:vendor/package.tgz"`
