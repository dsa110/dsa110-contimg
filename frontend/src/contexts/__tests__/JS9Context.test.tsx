...
describe("JS9Context", () => {
  ...
  describe("JS9Provider", () => {
    ...
    it("should provide hasImage function", () => {
      vi.mocked(js9Utils.isJS9Available).mockReturnValue(true);
      const displayWithImage = {
        id: "display-with-image",
        im: { id: "image-123" },
      };
    ...
    it("should provide getAllDisplays function", () => {
      ...
      vi.mocked(js9Utils.findDisplay).mockReturnValueOnce(display1).mockReturnValueOnce(display2);
      vi.mocked(js9Utils.getDisplayImageId).mockReturnValueOnce("image1").mockReturnValueOnce(null);
