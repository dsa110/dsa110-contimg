...
import { Error as ErrorIcon, Schedule as ScheduleIcon, CheckCircle as CheckCircleIcon, Cancel as CancelIcon } from '@mui/icons-material';
...
export function DeadLetterQueueStats() {
  ...
  const statItems = [
    ...
    { label: 'Resolved', value: stats.resolved, icon: <CheckCircleIcon />, color: 'success' as const },
