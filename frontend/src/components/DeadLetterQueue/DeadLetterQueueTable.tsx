...
export function DeadLetterQueueTable({
  ...
  const [dialogAction, setDialogAction] = useState<"retry" | "resolve" | "fail" | "view" | null>(
    null
  );
            ...
            <Stack spacing={2}>
              {dialogAction === "view" ? (
                ...
                <>
                  <Alert severity="info">
                    {dialogAction === "retry" &&
                      "This will mark the item as retrying and attempt to reprocess it."}
                    {dialogAction === "resolve" &&
                      "This will mark the item as resolved (manually fixed)."}
        ...
        <DialogActions>
          ...
          {dialogAction !== "view" && (
            <Button
              ...
              variant="contained"
              disabled={
                retryMutation.isPending || resolveMutation.isPending || failMutation.isPending
              }
            >
              Confirm
            </Button>
