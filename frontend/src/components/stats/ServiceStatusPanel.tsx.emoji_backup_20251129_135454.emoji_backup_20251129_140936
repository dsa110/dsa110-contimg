      ...
      <div className="mt-4 pt-4 border-t border-gray-200 dark:border-gray-700">
        <details className="text-sm">
          ...
          <div className="mt-2 p-3 bg-gray-50 dark:bg-gray-800/50 rounded text-gray-600 dark:text-gray-400 text-xs space-y-1">
            ...
            <p>• Services automatically kill any process occupying their assigned port</p>
            <p>• Services will NOT fall back to alternative ports</p>
            <p>• Managed by systemd with auto-restart on failure</p>
          </div>
        </details>
      </div>
    </div>
