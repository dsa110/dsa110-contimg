  ...
  useEffect(() => {
    ...
    import("golden-layout")
      .then((module) => {
        ...
        if (!GoldenLayout) {
          throw new Error(
            `GoldenLayout not found in module. Available exports: ${Object.keys(module).join(", ")}`
          );
        }

        if (!ComponentContainer) {
          throw new Error(
            `ComponentContainer not found in module. Available exports: ${Object.keys(module).join(", ")}`
          );
        }
