      ...
      <Card>
        <Box sx={{ borderBottom: 1, borderColor: 'divider' }}>
          <Tabs value={tabValue} onChange={handleTabChange} aria-label="pipeline tabs">
            <Tab label="Active Executions" id="pipeline-tab-0" aria-controls="pipeline-tabpanel-0" />
            <Tab label="Execution History" id="pipeline-tab-1" aria-controls="pipeline-tabpanel-1" />
