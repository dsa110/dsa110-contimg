...
CubiCal installation is blocked by `sharedarray` dependency compatibility issues:
...
- Command: `pip install 'cubical@git+https://github.com/ratt-ru/CubiCal.git@1.3.0'`
...
**Short-term**: Focus on CPU calibration optimizations (hierarchical calibration, parallel SPW processing) which provide immediate value without CubiCal.
