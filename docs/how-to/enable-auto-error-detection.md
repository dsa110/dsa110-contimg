...
Auto error detection automatically wraps all commands with error detection, ensuring errors are never ignored. This enforces the [Error Acknowledgment Rule](../.cursor/rules/error-acknowledgment.mdc) at the shell level.
...
- `ERROR_DETECTION_WRAPPER`: Path to wrapper script (default: `scripts/run-with-error-detection.py`)
...
- [Error Detection Wrapper](../scripts/README-error-detection.md) - Wrapper documentation
- [Immediate Error Termination](./immediate-error-termination.md) - How immediate kill works
- [Error Acknowledgment Rule](../.cursor/rules/error-acknowledgment.mdc) - The rule being enforced
