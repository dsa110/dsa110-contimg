...
Error detection is now configured system-wide and works automatically for all
users and all shell types.
...
- ✅ **All Shell Types**: Works for interactive, non-interactive, login,
  non-login
