...
Source the agent setup script at the start of any agentic session to ensure error detection is **always** enabled.
...
The agent setup script ensures error detection is enabled **regardless** of shell type or profile sourcing.

### Best Practice

**For maximum determinism**, always source the agent setup script at the start of agentic sessions:
