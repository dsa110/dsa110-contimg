...
4. ✅ Calibration (BP/G in development tier, K skipped by default)
...
# 2. Calibration (development tier)
python -m dsa110_contimg.calibration.cli calibrate \
  --ms /scratch/ms/<obs>.ms \
  --field 0 --refant 1 --preset development

# 3. Imaging (development tier)
