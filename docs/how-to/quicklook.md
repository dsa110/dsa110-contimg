...
- Phase-only gains by default in development tier; optional `--uvrange '>1klambda'` to speed solves
...
- Development tier: `--quality-tier development` reduces `imsize` and `niter` (⚠️ NON-SCIENCE)
