...
> **💡 Quick Start Guide:** For a simplified task-oriented guide, see
...
✅ **Index once, search anytime**: `python cli.py index-frontend`  
✅ **Find components**: `python cli.py search-components "query"`  
✅ **Find hooks**: `python cli.py search-hooks "query"`  
✅ **Track API usage**: `python cli.py find-api "/api/status"`  
✅ **Incremental updates**: Only changed files are re-indexed  
✅ **Shared cache**: Minimizes OpenAI API costs
