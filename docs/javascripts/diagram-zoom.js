  ...
  function initZoom() {
    ...
    mermaidContainers.forEach(function (container) {
      ...
      wrapper.style.cssText =
        "overflow: auto; max-width: 100%; max-height: 80vh; border: 1px solid #ddd; border-radius: 4px; padding: 10px; background: #fafafa; position: relative;";
      ...
      innerWrapper.style.cssText =
        "display: inline-block; transform-origin: top left; transition: transform 0.2s ease;";
      ...
      controls.style.cssText =
        "text-align: center; margin-top: 8px; padding: 5px; background: white; border-top: 1px solid #ddd; font-size: 12px; color: #666; display: flex; justify-content: center; align-items: center; gap: 10px;";

      const zoomOutBtn = document.createElement("button");
      zoomOutBtn.textContent = "−";
      zoomOutBtn.style.cssText =
        "cursor: pointer; padding: 4px 8px; border: 1px solid #ccc; background: white; border-radius: 3px; font-size: 16px;";
      ...
      resetBtn.style.cssText =
        "cursor: pointer; padding: 4px 8px; border: 1px solid #ccc; background: white; border-radius: 3px; font-size: 12px; margin-left: 10px;";
