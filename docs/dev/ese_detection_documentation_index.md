...
This document provides an index of all documentation related to ESE (Extreme Scattering Event) detection implementation.
...
2. **Pipeline Integration Module**
   ...
   - Functions: `update_variability_stats_for_source()`, `auto_detect_ese_for_new_measurements()`
   - Documentation: Inline docstrings
...
- [Photometry Guide](../../how-to/photometry_guide.md) - Photometry measurement procedures
- [Database Schema](../../reference/database_schema.md) - Database structure
- [API Reference](../../reference/api_reference_generated.md) - Complete API documentation
...
- Check user guide first: [ESE Detection Guide](../../how-to/ese_detection_guide.md)
- Review architecture: [ESE Detection Architecture](../../concepts/ese_detection_architecture.md)
