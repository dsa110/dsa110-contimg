...
This project maintains an internal record of design decisions, domain facts, and feature states. Contributors are encouraged to capture key decisions and context as part of their workflow (see internal docs).

## Daily Workflow

To ensure internal decision capture remains valuable and up-to-date, please adhere to the following daily practices:
...
This repository can use a post-commit hook that automatically records each commit for internal tooling.
