...
2. **Flat directory structure**: ✅ COMPLETED - Organized MS files by date and
...
5. **Missing directories**: ✅ COMPLETED - Created `science/`, `calibrators/`,
   `failed/` structure
6. **No archive mechanism**: Set up tape/cold storage workflow (TODO)
7. **Storage location registration**: ✅ COMPLETED - Base directories registered
