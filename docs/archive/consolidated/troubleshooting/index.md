...
| ------------------------------------------------------------- | ----------- | --------------- | -------------------------------------------------------------------------------------- |
| [Docker WSClean Hang](#docker-wsclean-hang)                   | :red_circle: Open     | Backend/Imaging | [docker-wsclean.md](docker-wsclean.md)                                                 |
| [Image Metadata Not Populated](#image-metadata-not-populated) | :red_circle: Open     | Database        | [known-issues/image-metadata-population.md](known-issues/image-metadata-population.md) |
| [CASA C++ Shutdown Error](#casa-c-shutdown-error)             | :check: Resolved | Testing/CASA    | [resolved/casa-shutdown-error.md](resolved/casa-shutdown-error.md)                     |
| [MS Permission Errors](#ms-permission-errors)                 | :check: Resolved | Backend/CASA    | [resolved/ms-permission-errors.md](resolved/ms-permission-errors.md)                   |
| [Frontend Restart Required](#frontend-restart-required)       | :check: Resolved | Frontend        | [resolved/frontend-restart-needed.md](resolved/frontend-restart-needed.md)             |
...
2. **Use standard format:**
   ...
   **Status:** :red_circle: Open | :yellow_circle: In Progress | :check: Resolved
