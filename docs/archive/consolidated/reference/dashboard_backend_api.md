...
> **:warning: Migration Status:** This documentation references the `legacy.backend`
> API implementation. The new `backend` is being developed with a cleaner
> architecture. These endpoints serve as the specification for what the new
...
- Real-time updates: WebSocket `/api/ws/status`, SSE `/api/sse/status` (planned)

## Implementation Status

| Endpoint Category | Legacy Backend | New Backend |
| ----------------- | -------------- | ----------- |
| Core Health       | :check: Implemented | :refresh: Planned  |
| WebSocket/SSE     | :check: Implemented | :refresh: Planned  |
| Jobs API          | :check: Implemented | :refresh: Planned  |
| Pipeline API      | :check: Implemented | :refresh: Planned  |
| Streaming API     | :check: Implemented | :refresh: Planned  |

## Reference Implementation

See `legacy.backend/src/dsa110_contimg/api/routes.py` for the complete
implementation that will be migrated to the new backend.
