...
## :clipboard: Standard Document Template
...
Analysis | Status Report | Reference] **Status:** [:check: Current | :check: Complete | :refresh:
In Progress | :clipboard: Planned] **Related:** [Optional: Links to related documents or
features]
...
**Date:** 2025-11-16 **Type:** Implementation Guide **Status:** :check: Complete
...
**Date:** 2025-11-16 **Type:** Troubleshooting **Status:** :check: Complete
...
**Date:** 2025-11-16 **Type:** Analysis **Status:** :check: Complete
...
**Date:** 2025-11-16 **Type:** Status Report **Status:** :check: Complete
...
## :refresh: Updating Documentation
...
3. **Update Status**: Change if needed (Current :arrow_right: Complete, etc.)
...
**Date:** 2025-11-14 :arrow_left: Update if significant changes **Status:** :refresh: In Progress
:arrow_left: Change to :check: Complete when done

[Content updates here...]

---

**Last Updated:** 2025-11-16 :arrow_left: Always update this
```

---

## :folder_open: Adding New Documentation
...
| [NEW_FEATURE_IMPLEMENTATION.md](./NEW_FEATURE_IMPLEMENTATION.md) | 2025-11-16 | New feature implementation details | :check: Complete |
...
## :label::variation_selector-16: Status Values

### When to Use Each Status

- **:check: Current**: Document is actively maintained and accurate
  - Use for: Living documentation, actively used guides
  - Update regularly to keep date recent

- **:check: Complete**: Work is finished, document is final
  - Use for: Completed implementations, resolved issues
  - No further updates expected

- **:refresh: In Progress**: Work is ongoing
  - Use for: Features under development, ongoing analysis
  - Update regularly as work progresses

- **:clipboard: Planned**: Documented but not yet implemented
  - Use for: Planned features, future work
  - Update when work begins (:arrow_right: In Progress)

- **:warning: Deprecated**: Documented approach is outdated
  - Use for: Old approaches being replaced
  - Should link to replacement document

---

## :link_symbol: Linking Best Practices
...
- **Type:** One of: Implementation Guide | Troubleshooting | Analysis | Status
  Report | Reference
- **Status:** One of: :check: Current | :check: Complete | :refresh: In Progress | :clipboard: Planned
...
```markdown
| [Document Name](./FILENAME.md) | YYYY-MM-DD | Brief description | :check: Current |
```

---

## :rocket: Quick Start for AI Agents
...
## :telephone_receiver: Questions or Issues?
