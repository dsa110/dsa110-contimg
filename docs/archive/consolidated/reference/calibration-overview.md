...
- Short baselines (< 100 km) :arrow_right: atmospheric delays partially cancel
- Known instrumental delays incorporated into correlator model
- Residual delays < 0.5 ns :arrow_right: absorbed into complex gain calibration
...
- [Calibration Tutorial](CURRENT_CALIBRATION_PROCEDURE.md) - Step-by-step
  workflow
