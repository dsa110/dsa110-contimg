...
1. **MS Validation** :check:
2. **Pre-Calibration Flagging** :check:
3. **Model Data Population** :check: (using pyradiosky)
4. **Bandpass Calibration (BP)** :check: (enabled by default)
5. **Gain Calibration (G)** :check: (enabled by default)
6. **Calibration Table Validation** :check:

**K-Calibration (Delay):** :cross: **Skipped by default**
...
- **Single calibrator:** `make_point_cl()` :arrow_right: pyradiosky :arrow_right: componentlist
- **NVSS sources:** `make_nvss_component_cl()` :arrow_right: pyradiosky :arrow_right: componentlist
...
**Status:** :check: **Enabled by default**
...
**Status:** :cross: **Skipped by default**
...
- `make_point_cl()` :arrow_right: pyradiosky :arrow_right: componentlist
- `make_nvss_component_cl()` :arrow_right: pyradiosky :arrow_right: componentlist
...
1. :check: **MS Validation** - Comprehensive checks
2. :check: **Pre-Calibration Flagging** - Zero-value data (default)
3. :check: **Model Data Population** - pyradiosky (default) :arrow_right: componentlist :arrow_right: `ft()`
4. :check: **Bandpass Calibration** - Enabled by default
5. :check: **Gain Calibration** - Enabled by default
6. :cross: **Delay Calibration** - Skipped by default (use `--do-k` to enable)
