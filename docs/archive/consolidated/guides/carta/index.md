...
| --------------------- | ---------- | ----------------------------- |
| CARTA Container       | :check: Running | `carta-backend`               |
| CARTA Version         | 5.0.3      | -                             |
| Backend Port          | 9002       | `http://localhost:9002/`      |
| Dashboard Integration | :check: Active  | `http://localhost:3210/carta` |
...
- **Location:** Top navigation bar :arrow_right: "CARTA"
- **Route:** `/carta`
...
- **Location:** `/data` :arrow_right: select image :arrow_right: "View in CARTA"
- **Route:** `/data` :arrow_right: `/images/:imageId` :arrow_right: `/carta?file=<path>`
