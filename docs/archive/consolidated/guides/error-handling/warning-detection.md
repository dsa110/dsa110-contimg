...
The error detection system now **also terminates commands when warning messages
are detected**, not just errors.
...
- **Deprecation warnings**: `DeprecationWarning`, `PendingDeprecationWarning`,
  `FutureWarning`
- **Test warnings**: `WARNING.*test.*skipped`, `WARNING.*test.*failed`
- **Database warnings**: `WARNING.*database`, `WARNING.*table`,
  `WARNING.*column`, `WARNING.*schema`
- **CASA warnings**: `WARNING.*SEVERE`, `WARNING.*Exception`
- **Build warnings**: `WARNING.*build`, `WARNING.*compilation`
- **System warnings**: `WARNING.*Permission`, `WARNING.*Access`,
  `WARNING.*denied`
- **Critical warnings**: `WARNING.*CRITICAL`, `WARNING.*FATAL`,
  `WARNING.*Error`, `WARNING.*Failed`
- **Data quality warnings**: `WARNING.*invalid`, `WARNING.*corrupt`,
  `WARNING.*missing`, `WARNING.*not found`
- **Configuration warnings**: `WARNING.*config`, `WARNING.*setting`,
  `WARNING.*parameter`
...
1. **Immediate termination**: Command is killed immediately (same as error
   detection)
...
Warning detection is **always enabled** when using the error detection wrapper.
There is no option to disable it separately from error detection.
