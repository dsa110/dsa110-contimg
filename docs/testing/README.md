...
- :check: Control Page (Convert, Calibrate, Apply, Image tabs)
- :check: Data Browser Page
- :check: Data Detail Page
- :check: Streaming Page
- :check: Mosaic Gallery Page
- :check: Source Monitoring Page
- :check: Sky View Page
...
- :check: Table/List Interactions
- :check: Modal/Dialog Interactions
