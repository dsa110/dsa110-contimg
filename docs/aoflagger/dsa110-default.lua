--[[
 DSA-110 AOFlagger Strategy
 Version: 2025-11-05
 Based on: generic-default.lua
 
 This strategy is optimized for DSA-110 continuum observations.
 DSA-110 is a 110-element interferometer observing at ~1.4 GHz.
 
 Key DSA-110 characteristics:
 - Frequency: ~1.4 GHz (L-band)
 - 16 subbands per observation
 - Short baselines (max ~2.6 km)
 - Continuum imaging (not spectral line)
 - Typical RFI: GPS satellites, cell phones, WiFi
 
 Strategy parameters can be tuned based on RFI environment
 at the DSA-110 site (Owens Valley Radio Observatory).
]]
...
function execute(input)
  ...
  -- For DSA-110, start with 1.0 (can be tuned based on RFI environment)
  ...
  -- 3 iterations is a good balance for DSA-110
