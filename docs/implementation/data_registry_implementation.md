...
The data registry system has been fully implemented, providing automatic and manual publishing of pipeline data products from SSD (`/stage/`) to HDD (`/data/dsa110-contimg/products/`).
...
- Table renames: `ms_index` → `ms_all`, `images` → `images_all`, `mosaics` → `mosaics_all`

### 2. Directory Structure ✓
- `/stage/dsa110-contimg/` (SSD): Fast access for active work
  - Subdirectories: `ms/`, `calib_ms/`, `caltables/`, `images/`, `mosaics/`, `catalogs/`, `qa/`, `metadata/`
