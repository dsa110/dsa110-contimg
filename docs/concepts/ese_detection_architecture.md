...
The ESE (Extreme Scattering Event) detection system automatically identifies radio sources with significant flux variability (>5σ) by analyzing photometry measurements over time. This document describes the architecture and design decisions.
...
3. Format as `J{ra_h:02d}{ra_m:02d}{ra_s:02d}{dec_sign}{dec_d:02d}{dec_m:02d}{dec_s:02d}`
...
5. **Advanced Metrics**: Additional variability metrics (e.g., structure function)
