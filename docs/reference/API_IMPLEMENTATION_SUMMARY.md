...
- :check: Health check
- :check: MS metadata and calibrator matches
- :check: Source detail
- :check: Job provenance and logs
- :check: QA endpoints (image, MS, job)
- :check: Calibration table detail
- :check: Error responses (404s) with proper envelopes
