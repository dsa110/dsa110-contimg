...
The FIRST (Faint Images of the Radio Sky at Twenty Centimeters) radio survey has
**patchy sky coverage** focused on specific regions rather than uniform all-sky
coverage.
...
- **Purpose:** Designed to overlap with Sloan Digital Sky Survey (SDSS)
  footprint
...
- Declinations > +42°
- Most of the sky between −1° and +28° (gap between equatorial strip and north
  cap)
...
- FIRST Survey Parameters:
  http://sundog.stsci.edu/first/catalog_paper/node2.html
