...
class TestDetectESECandidates:
    ...
    def test_detect_ese_candidates_specific_source(
        self, temp_products_db, sample_variability_stats
    ):
    ...
    def test_detect_ese_candidates_higher_threshold(
        self, temp_products_db, sample_variability_stats
    ):
    ...
    def test_detect_ese_candidates_updates_existing(
        self, temp_products_db, sample_variability_stats
    ):
    ...
    def test_detect_ese_candidates_recompute(
        self, mock_recompute, temp_products_db, sample_variability_stats
    ):
